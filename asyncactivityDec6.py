...
def state_landmarks(state):
    if state == "pennsylvania":
        return "The landmark of pennsylvania is the liberty bell."
       elif state == " New york":
        return "The landmark of the new your is the statue ofr liberty."
        elif state == "california":
            return " The landmark of california is the "