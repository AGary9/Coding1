...
def check numbers(num):
   if num > 0:
    ...
    print (check_numbers(10))
    Print (check_number(-5))
    print (check)


You have been hired by netflix to help them develop a movie ticket program. You must create a function that will check the movie goers age and return the price of the movie ticket based on that person's age. Provided are the lists of age and the prices:
